---
title: Scatter plot demo Heart ❤️ & Impulse 
...
The python script is available here: [scatter plot]({{ '/download/scatter_plot.py' | relative_url }}).<br />
...
plt.show()
```
![demo plot1]({{ '/assets/img/2023-05-18/Heart.png' | relative_url }})
...
plt.show()
```
![demo plot1]({{ '/assets/img/2023-05-18/Impulse.png' | relative_url }})
